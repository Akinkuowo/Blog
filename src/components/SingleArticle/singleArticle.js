                ...
                <div className="container">
                    ...
                    <div className="row">
                         <div className="col-12 col-lg-8 offset-lg-2">       
                            <p className="lead">Dynamically procrastinate professional best practices vis-a-vis next-generation content. Seamlessly extend sustainable networks via plug-and-play niche markets. Progressively communicate customized alignments for client-focused
                            ...
                            scenarios via inexpensive ROI. Proactively build seamless markets rather than world-className channels. Objectively
